...
def calculateHandlen(hand):
    ...
    for key, values in hand.items():
        number_of_letters += values
    ...
    while calculateHandlen(hand) > 0:
        ...
        # Otherwise (the input is not a single period):
            ...
            # Otherwise (the word is valid):
                ...
                total_score += getWordScore(word, n)  # Tell the user how many points the word earned, and the updated total score, in one line followed by a blank line
...
def playGame(wordList):
    ...
    hand = {}
    while True:
        game_option = input("Enter n to deal a new hand, r to replay the last hand, or e to end the game:")
